...
app.config['MAIL_USERNAME']='hekimaplatform@gmail.com'
app.config['MAIL_PASSWORD']='jgkg qpcy pogt teoq'
...
def verify():
    ...
    msg=Message("OTP ",sender='hekimaplatform@gmail.com',recipients=[email])
    msg.body=str(otp)
    print(msg.body)
    mail.send(msg)
